---
created: 20211105151523728
modified: 20211106114007610
title: AND OR NOT
---
...
`WHERE birth_date > '1990-01-01' AND points > 1000` both the conditions have to be true for the [WHERE](#WHERE) clause to return

### OR

`WHERE birth_date > '1990-01-01' OR points > 1000` either of the conditions have to be true for the [WHERE](#WHERE) clause to return
